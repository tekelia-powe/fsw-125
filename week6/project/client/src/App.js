...
import AddSearchForm from './components/AddSearchForm.js'
...
export default function App(){
    ...
    function searchBounty(searchItem){
        console.log(searchItem)
        axios.get(`/bounty/lastName/${searchItem}`)
    ...
    return(
        <div className="container">
            ...
            <img src={pic1} alt="Bounty Hunter"/>
